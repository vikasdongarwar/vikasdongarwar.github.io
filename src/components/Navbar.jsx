...
import vikas from "../views/VikasDongarwar.pdf"
...
const Navbar = () => {
  ...
  const links = [
    ...
    // {
    //   name: "Resume",
    //   route: "https://drive.google.com/file/d/1pNVdYWb4dIqKoryYfiHFsypd4Zst5zwp/view",
    // },
  ];
            ...
            >
              ...
              <a  className={
                      darkMode
                        ? "block py-2 px-3 text-black hover:bg-blue-500 hover:text-white rounded-md"
                        : "block py-2 px-3 text-white hover:bg-blue-500 hover:text-black rounded-md"
                    } href="https://drive.google.com/file/d/1pNVdYWb4dIqKoryYfiHFsypd4Zst5zwp/view" target="_blank">Resume</a>
            </ul>
